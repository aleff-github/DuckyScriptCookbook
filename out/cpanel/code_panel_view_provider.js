        ...
        webviewView.webview.onDidReceiveMessage(data => {
            ...
            switch (data.type) {
                ...
                case 'GENERALIZED_WINDOWS_USER_PATH_3_0':
                    active.edit(editBuilder => {
                        const code = new cpanel.Code(this._extension.extensionUri);
                        editBuilder.replace(selection, code.duckyscript(this._extension.asAbsolutePath(consts_1.PATH_TO_COOKBOOK.GENERALIZED_WINDOWS_USER_PATH_3_0)));
                    });
                    break;
                case 'PHYSICAL_EXFILTRATION_3_0':
                    active.edit(editBuilder => {
                        const code = new cpanel.Code(this._extension.extensionUri);
                        editBuilder.replace(selection, code.duckyscript(this._extension.asAbsolutePath(consts_1.PATH_TO_COOKBOOK.PHYSICAL_EXFILTRATION_3_0)));
                    });
                    break;
                case 'NETWORK_EXFILTRATION_3_0':
                    active.edit(editBuilder => {
                        const code = new cpanel.Code(this._extension.extensionUri);
                        editBuilder.replace(selection, code.duckyscript(this._extension.asAbsolutePath(consts_1.PATH_TO_COOKBOOK.NETWORK_EXFILTRATION_3_0)));
                    });
                    break;
                ...
                case 'GENERALIZED_WINDOWS_USER_PATH_1_0':
                    active.edit(editBuilder => {
                        const code = new cpanel.Code(this._extension.extensionUri);
                        editBuilder.replace(selection, code.duckyscript(this._extension.asAbsolutePath(consts_1.PATH_TO_COOKBOOK.GENERALIZED_WINDOWS_USER_PATH_1_0)));
                    });
                    break;
                // Both
                case 'OPEN_SHELL':
...
function getRecipeMarkup(items) {
